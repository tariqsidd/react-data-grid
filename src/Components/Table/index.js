...
const initializeFilters = (columns) => {
  ...
  columns.forEach(column => {
    initialFilters[column.field] = column.filterType === 'dateSelect' ? null : '';
  });
  return initialFilters;
};

export const MaterialTable = ({options, columns, data, page=1, setPage=()=>{}, isNextPage=true, ssf, onChangeFilter=()=>{}}) => {
  // Example data
